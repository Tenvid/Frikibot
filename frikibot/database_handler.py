...
def create_trainer(trainer_name: str, trainer_code: str) -> None:
        ...
        with sqlite3.connect(DATABASE) as conn:
                ...
                cursor.execute(
                        ...
                        # Injection and I want the possibility to change table name
                        # with .env
...
""")
                        ...
                        logger.error(
                                "There was an error creating the %s table", TRAINER_TABLE
                        )
...
""")
                        ...
                        logger.error(
                                "There was an error creating %s table", POKEMON_TABLE
                        )
