...
class Pokemon:
        ...
        def __init__(
                ...
                *,
                ...
                try:
                        ...
                        logger.warning(
                                "Modified stats could not be obtained from nature"
                                ", defaulting to None."
                        )
        ...
        def _get_pokemon_moves(self, available_moves: list[dict]) -> list[str]:
                ...
                Args:
                ----
                    available_moves (list[dict): List of all moves this Pokémon can learn.
                ...
                ret: list = []
                while len(ret) < 4:
                        move = available_moves[randbelow(len(available_moves))]["move"][
                                "name"
                        ]
