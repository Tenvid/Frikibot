...
class Stats:
        ...
        def __init__(
                ...
                *,
                ...
                ----
                    ...
                    decreased (dict | None, optional): Stat decreased. Defaults to None.
                    increased (dict | None, optional): Stat increased. Defaults to None.
        ...
        def __str__(self) -> str:
                ...
                ret += "\n".join(
                        [
                                self.add_color_nature(stat_tuple=x)
                                for x in self.get_stats_list()
                        ]
                )
                ret += "```"
                return ret
        ...
        def add_color_nature(self, stat_tuple: tuple[str, int]) -> str:
                ...
                if self.decreased and stat_tuple[0] == self.decreased["name"]:
                        return (
                                f"\u001b[0;34m"
                                f"{stat_tuple[0].replace('-', ' ').capitalize()}:"
